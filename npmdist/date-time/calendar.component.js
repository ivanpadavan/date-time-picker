...
var OwlCalendarComponent = (function () {
    ...
    Object.defineProperty(OwlCalendarComponent.prototype, "isYearView", {
        get: function () {
    ...
    OwlCalendarComponent.prototype.toggleBetweenMonthAndYearViews = function () {
        this.currentView = this._currentView == 'month' ? 'year' : 'month';
    };
    OwlCalendarComponent.prototype.toggleBetweenYearAndMultiYearViews = function () {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], OwlCalendarComponent.prototype, "_currentView", void 0);
    __decorate([
